define ([], function () {
    ...
    $_DO.update_overhaul_short_program_house_works_popup = function (e) {

        var data = clone ($('body').data ('data'))

        var f = w2ui ['overhaul_short_program_house_works_popup_form']
        ...
        var tia = {type: 'overhaul_short_program_house_works'}
        tia.id = f.record.id
