    ...
    $_DO.check_licenses = function (e) {
        ...
        function load (ogrn, label) {
            ...
            w2confirm (label + ' ' + ogrn + ' не найден. Запросить информацию в ГИС ЖКХ?').yes (function () {
                ...
                query ({type: 'licenses', action: 'import', id: undefined}, {data: {licensegiud: licensegiud}}, function (d) {

                    darn (d)
                    
                        var clock = setInterval (function () {
                    
                            query ({type: 'out_soap_export_nsi_item', part: 'rq', id: d.id}, {data: {licensegiud: licensegiud}}, function (out_soap) {
                                darn (out_soap)                        
