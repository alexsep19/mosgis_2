define ([], function () {
    ...
    $_DO.choose_tab_overhaul_short_program_house = function (e) {
        ...
        localStorage.setItem ('overhaul_short_program_house.active_tab', name)
    ...
    return function (done) {
        ...
        query ({type: 'overhaul_short_program_houses'}, {}, function (data) {
