define([], function () {
    ...
    $_DO.edit_supply_resource_contract_subject_other_quality_levels = function (e) {
    ...
    $_DO.delete_supply_resource_contract_subject_other_quality_levels = function (e) {
        ...
        query({type: 'supply_resource_contract_other_quality_levels', id: grid.getSelection() [0], action: 'delete'}, {}, function () {
            ...
            use.block('supply_resource_contract_subject_other_quality_levels')
