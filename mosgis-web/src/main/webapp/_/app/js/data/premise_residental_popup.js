define ([], function () {
    ...
    $_DO.update_premise_residental_popup = function (e) {

        var form = w2ui ['premise_residental_new_form']
        ...
        if (v.uuid_entrance == null) die ('uuid_entrance', 'Укажите, пожалуйста, номер подъезда')
        ...
        var tia = {type: 'premises_residental'}        
