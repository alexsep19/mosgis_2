define ([], function () {
    ...
    $_DO.download_supply_resource_contract_docs_popup = function (e) {
        ...
        download ({
            ...
            id:     w2ui ['supply_resource_contract_docs_popup_form'].record.id,
            action: 'download',
    ...
    $_DO.update_supply_resource_contract_docs_popup = function (e) {

        var form = w2ui ['supply_resource_contract_docs_popup_form']
        ...
        query ({type: 'supply_resource_contract_docs', action: 'edit', id: form.record.id}, {data: v}, reload_page)
