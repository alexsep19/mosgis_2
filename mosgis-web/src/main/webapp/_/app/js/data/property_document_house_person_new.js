define ([], function () {
    ...
    var form_name = 'property_document_house_person_new_form'

    $_DO.update_property_document_house_person_new = function (e) {
    ...
    return function (done) {
        ...
        data.vc_persons = [{id: data.record.uuid_person_owner, text: data.record.label_person_owner}]

        delete data.record.label_person_owner
