define ([], function () {
    ...
    $_DO.update_supply_resource_contract_object_quality_levels_popup = function (e) {

        var form = w2ui ['supply_resource_contract_object_quality_level_form']
        ...
        var grid = w2ui ['supply_resource_contract_object_quality_levels_grid']
    ...
    return function (done) {
        ...
        query(
           {type: 'supply_resource_contract_object_quality_levels', part: 'vocs', id: undefined}
