define ([], function () {
    ...
    $_DO.download_charter_doc_popup = function (e) {    
        ...
        download ({
            ...
            type:   'charter_docs', 
            id:     w2ui ['charter_doc_popup_form'].record.id,
            action: 'download',
    ...
    $_DO.update_charter_doc_popup = function (e) {
    
        var form = w2ui ['charter_doc_popup_form']
    ...
    return function (done) {
        ...
        var grid = w2ui ['charter_docs_grid']
