define ([], function () {
    ...
    $_DO.patch_premise_residental_passport = function (e) {    
        ...
        var tia = {type: 'premises_residental', action: 'update'}
        ...
        query (tia, {data: dd}, function () {
            ...
            if (d.k == 'f_20126') { // непригодность
                ...
                var id = "premise_residental_invalid"
                
                if (d.v == 0) {
                
                    query ({type: 'premises_residental', action: 'update'}, {data: {
    ...
    return function (done) {
        ...
        query ({type: 'premises_residental', part: 'passport_fields'}, {}, function (d) {
