define ([], function () {
    ...
    $_DO.create_overhaul_address_program_files = function (e) {
            
        use.block ('overhaul_address_program_doc_files_new')
    
    }
    
    $_DO.download_overhaul_address_program_files = function (e) {    
    ...
    $_DO.delete_overhaul_address_program_files = function (e) {    
