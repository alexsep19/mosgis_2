define ([], function () {
    ...
    $_DO.update_mgmt_contract_object_doc_new = function (e) {

        var f = w2ui ['mgmt_contract_object_doc_new_form']
        ...
        var data = {
            uuid                 : $('body').data ('data').item.uuid_contract,
            uuid_contract_object : $_REQUEST.id,
