define ([], function () {
    ...
    $_DO.download_premise_residental_invalid = function (e) {    
    ...
    $_DO.cancel_premise_residental_invalid = function (e) {
    ...
    $_DO.edit_premise_residental_invalid = function (e) {
    ...
    $_DO.update_premise_residental_invalid = function (e) {
        ...
        if (v.file) {
            ...
            var check = setInterval (function () {
                ...
                clearInterval (check)
                $_DO.apologize = $.noop
                query ({type: 'premises_residental', action: 'update'}, {data: {f_20127: v.f_20127}}, reload_page)
//                reload_page ()
            }, 100)
