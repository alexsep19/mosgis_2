define ([], function () {
    ...
    $_DO.patch_charter_payment_common_service_payments = function (e) {
    ...
    $_DO.delete_charter_payment_common_service_payments = function (e) {
        ...
        query ({type: 'service_payments', id: grid.getSelection () [0], action: 'delete'}, {}, function () {
            ...
            use.block ('charter_payment_common_service_payments')
