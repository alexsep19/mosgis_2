define ([], function () {
    ...
    var form_name = 'overhaul_regional_program_houses_new_form'
    var grid_name = 'overhaul_regional_program_houses_grid'
    ...
    $_DO.update_overhaul_regional_program_houses_new = function (e) {
        ...
        var tia = {type: 'overhaul_regional_program_houses'}
        ...
        query (tia, {data: v}, function (data) {
            ...
            if (data.id) w2confirm ('Перейти на страницу дома и видов работ?').yes (function () {openTab ('/overhaul_regional_program_house/' + data.id)})
