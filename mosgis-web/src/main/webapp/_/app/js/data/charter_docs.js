define ([], function () {
    ...
    $_DO.edit_charter_docs = function (e) {
            
        use.block ('charter_doc_popup')
    
    }    
    
    $_DO.create_charter_docs = function (e) {
            
        use.block ('charter_doc_new')
    
    }
    
    $_DO.download_charter_docs = function (e) {    
    ...
    $_DO.delete_charter_docs = function (e) {    
