define ([], function () {
    ...
    $_DO.update_supply_resource_contract_subject_other_quality_levels_popup = function (e) {
        ...
        var tia = {type: 'supply_resource_contract_other_quality_levels'}
        tia.id = form.record.id
        tia.action = tia.id ? 'update' : 'create'
        
        var done = reload_page

        var grid = w2ui ['supply_resource_contract_subject_other_quality_levels_grid']
    ...
    return function (done) {
        ...
        query(
           {type: 'supply_resource_contract_other_quality_levels', part: 'vocs', id: undefined}
