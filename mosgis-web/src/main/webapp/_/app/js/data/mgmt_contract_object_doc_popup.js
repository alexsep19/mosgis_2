define ([], function () {
    ...
    $_DO.download_mgmt_contract_object_doc_popup = function (e) {    
        ...
        download ({
            ...
            type:   'contract_docs', 
            id:     w2ui ['mgmt_contract_object_doc_popup_form'].record.id,
            action: 'download',
    ...
    $_DO.update_mgmt_contract_object_doc_popup = function (e) {
    
        var form = w2ui ['mgmt_contract_object_doc_popup_form']
    ...
    return function (done) {
        ...
        var grid = w2ui ['mgmt_contract_object_docs_grid']
