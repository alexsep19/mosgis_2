define ([], function () {
    ...
    $_DO.edit_infrastructure_docs = function (e) {
            
        use.block ('infrastructure_docs_popup')
    
    }    
    
    $_DO.create_infrastructure_docs = function (e) {
            
        use.block ('infrastructure_docs_new')
    
    }
    
    $_DO.download_infrastructure_docs = function (e) {    
    ...
    $_DO.delete_infrastructure_docs = function (e) {    
