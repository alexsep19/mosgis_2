        ...
        $(view).w2popup ('open', {
            ...
            onOpen: function (event) {
                ...
                event.onComplete = function () {
                    ...
                    var name = 'mgmt_contract_doc_popup_form'
                    ...
                    clickOn ($('#w2ui-popup button'), $_DO.update_mgmt_contract_doc_popup)
                    clickOn ($('#file_label'), $_DO.download_mgmt_contract_doc_popup)
