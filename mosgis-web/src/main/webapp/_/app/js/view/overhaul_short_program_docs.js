define ([], function () {
    ...
    return function (data, view) {
        ...
        $(w2ui ['topmost_layout'].el ('main')).w2regrid ({ 
            ...
            name: 'overhaul_short_program_docs_grid',
            ...
            url: '/_back/?type=overhaul_short_program_documents',

            postData: {program_uuid: $_REQUEST.id},

            onAdd: $_DO.create_overhaul_short_program_doc,
            
            onDblClick: function (e) {
                openTab ('/overhaul_short_program_doc/' + e.recid)
            },
