define ([], function () {
    ...
    return function (data, view) {
        ...
        if (it ['out_soap.err_text']) {
            ...
            it.sync_label = 'Ошибка приема или передачи в ГИС ЖКХ. Подробности на вкладке "История изменений"'
                ...
                {type: 'main', size: 400,
                    ...
                    tabs: {
                        ...
                        tabs: [
                            ...
                            {id: 'supply_resource_contract_accounts',           caption: 'Лицевые счета', off: !it.contractrootguid || (it.id_customer_type == 5 && it.countingresource == 0)},
