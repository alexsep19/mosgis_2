define ([], function () {
    ...
    var grid_name = 'charter_accounts_grid'
    ...
    return function (data, view) {
        ...
        $panel.w2regrid ({ 
            ...
            toolbar: {
                ...
                items: [
                    {type: 'button', id: 'ind', caption: 'Добавить ЛС физического лица', onClick: $_DO.create_charter_accounts, off: !data.item._can.create_account, icon: 'w2ui-icon-plus'},
                    {type: 'button', id: 'org', caption: 'Добавить ЛС юридического лица', onClick: $_DO.create_charter_accounts, off: !data.item._can.create_account, icon: 'w2ui-icon-plus'},
                ].filter (not_off),
            ...
            onAdd: $_DO.create_charter_accounts,
