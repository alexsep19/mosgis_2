define ([], function () {
    ...
    var grid_name = 'premise_nonresidental_passport_grid'
    var id2field = {}
...
//                {field: 'ord_src', caption: '№ п/п', size: 5},
                ...
                {field: 'value', caption: 'Значение', size: 20, attr: 'data-status', editable: !data.is_passport_editable ? null : function (voc) {                
                    ...
                    if (voc.is_multiple) {
                        ...
                        switch (voc.id_type) {                    
                            case 6:
                                var d = getData ()
                                var ids = d ['tb_premises_nrs_f_' + voc.id]
                                var s = ''
            ...
            onEditField: function (e) {
                ...
                if (record.is_multiple) {
                    ...
                    var o = {
                        ...
                        ids: d ['tb_premises_nrs_f_' + record.id]
                    }
            ...
            onChange: $_DO.patch_premise_nonresidental_passport,
