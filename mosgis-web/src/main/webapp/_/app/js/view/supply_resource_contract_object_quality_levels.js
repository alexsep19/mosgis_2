define ([], function () {
    ...
    var grid_name = 'supply_resource_contract_object_quality_levels_grid'
    ...
    return function (data, view) {
        ...
        $panel.w2regrid ({
            ...
            url: '/mosgis/_rest/?type=supply_resource_contract_object_quality_levels',

            onDblClick: $_DO.edit_supply_resource_contract_object_quality_levels,
                ...
                for (key in content) {
                    ...
                    $.each(data.vc_nsi_276.items, function () {
                        if(!seen [this.id]) {
                            rs.push({
                                id: k--,
                                uuid_sr_ctr_obj: data.item.uuid,
