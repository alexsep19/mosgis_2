define ([], function () {
    ...
    return function (data, view) {
        ...
        $_F5 = function (data) {
            ...
            $('div[data-block-name=social_norm_tarif_common] input, textarea').prop ({disabled: data.__read_only})
        ...
        $panel.w2relayout ({
            ...
            panels: [
                ...
                {type: 'main', size: 400,
                    tabs: {
                        tabs: [
                            {id: 'social_norm_tarif_common_log', caption: 'История изменений'},
                        ],
                        onClick: $_DO.choose_tab_social_norm_tarif_common
                    }
                }
            ],
            onRender: function (e) {
