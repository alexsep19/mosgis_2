define ([], function () {
    ...
    var grid_name = 'overhaul_address_program_files_grid'
    ...
    return function (data, view) {
        ...
        $panel.w2regrid ({ 
            ...
            onDblClick: $_DO.download_overhaul_address_program_files,
            
            onDelete: $_DO.delete_overhaul_address_program_files,
            
            onAdd: $_DO.create_overhaul_address_program_files,
