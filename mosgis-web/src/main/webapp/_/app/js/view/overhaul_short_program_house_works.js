define ([], function () {
    ...
    return function (data, view) {
        ...
        $panel.w2regrid ({ 
            ...
            toolbar: {
                items: [
                    ...
                    },
                    {
                        ...
                        onClick: $_DO.edit_overhaul_short_program_house_works, 
                    ...
                    },
                    {
                        ...
                        id: 'deleteButton',
                        caption: 'Удалить',
                        onClick: $_DO.delete_overhaul_short_program_house_works,
            ...
            url: '/_back/?type=overhaul_short_program_house_works',
            
            onAdd: $_DO.create_overhaul_short_program_house_works,
