define ([], function () {
    ...
    return function (data, view) {
        ...
        $(w2ui ['passport_layout'].el ('main')).w2regrid ({ 
            ...
            name: 'overhaul_address_program_houses_grid',
            ...
            url: '/_back/?type=overhaul_address_program_houses',

            postData: {program_uuid: $_REQUEST.id},

            onAdd: $_DO.create_overhaul_address_program_house,
            onDelete: $_DO.delete_overhaul_address_program_house,
            
            onDblClick: function (e) {
                openTab ('/overhaul_address_program_house/' + e.recid)
            },
