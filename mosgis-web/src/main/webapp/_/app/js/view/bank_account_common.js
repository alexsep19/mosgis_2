define ([], function () {
    ...
    return function (data, view) {
        ...
        $_F5 = function (data) {
            ...
            $('div[data-block-name=bank_account_common] input').prop({disabled: data.__read_only})
        ...
        $panel.w2relayout ({
            ...
            panels: [
                ...
                {type: 'main', size: 300,
                    tabs: {
                        tabs:    [
                            {id: 'bank_account_common_log', caption: 'История изменений'},
                        ],
                        onClick: $_DO.choose_tab_bank_account_common
                    }
                },
