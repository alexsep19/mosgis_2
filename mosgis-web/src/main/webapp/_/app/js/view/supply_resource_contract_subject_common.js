define ([], function () {
    ...
    function recalc () {
        ...
        var is_volume = it['sr_ctr.isplannedvolume'] && it['sr_ctr.plannedvolumetype'] == 10
        var is_on = {
            '#tr_volume'     : is_volume,
    ...
    return function (data, view) {
        ...
        $_F5 = function (data) {
            ...
            $('div[data-block-name=supply_resource_contract_subject_common] input').prop ({disabled: data.__read_only})
