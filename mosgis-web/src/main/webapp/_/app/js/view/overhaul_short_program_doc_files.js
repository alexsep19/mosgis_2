define ([], function () {
    ...
    var grid_name = 'overhaul_short_program_files_grid'
    ...
    return function (data, view) {
        ...
        $panel.w2regrid ({ 
            ...
            url: '/_back/?type=overhaul_short_program_files',
            
            onDblClick: $_DO.download_overhaul_short_program_files,
            
            onDelete: $_DO.delete_overhaul_short_program_files,
            
            onAdd: $_DO.create_overhaul_short_program_files,
