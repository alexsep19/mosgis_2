...
@Path ("supply_resource_contract_object_quality_levels")
public class SupplyResourceContractObjectQualityLevels extends EJBResource <SupplyResourceContractObjectQualityLevelLocal> {
