...
@Path ("tarif_legal_acts")
public class TarifLegalActs extends EJBResource <TarifLegalActLocal> {
/*    
    ...
    private void checkOrg (JsonObject item) {
        ...
        if (itemOrg == null) throw new InternalServerErrorException ("Wrong PremiseUsageTarifLegalAct, no org: " + item);
