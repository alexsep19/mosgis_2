...
@Path ("supply_resource_contract_object_subjects")
public class SupplyResourceContractObjectSubjects extends EJBResource <SupplyResourceContractObjectSubjectLocal> {
