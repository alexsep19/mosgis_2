...
@Path ("supply_resource_contract_object_temperature_charts")
public class SupplyResourceContractObjectTemperatureCharts extends EJBResource <SupplyResourceContractObjectTemperatureChartLocal> {
