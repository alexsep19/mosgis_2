...
@Path ("premise_usage_tarifs")
public class PremiseUsageTarifs extends EJBResource <PremiseUsageTarifLocal> {
/*    
    ...
    private void checkOrg (JsonObject item) {
        ...
        if (itemOrg == null) throw new InternalServerErrorException ("Wrong PremiseUsageTarif, no org: " + item);
