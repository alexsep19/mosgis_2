...
@Path ("municipal_services")
public class MainMunicipalServices extends EJBResource <MainMunicipalServiceLocal> {
    ...
    private void checkOrg (JsonObject item) {
        ...
        if (itemOrg == null) throw new InternalServerErrorException ("Wrong MainMunicipalService, no org: " + item);
