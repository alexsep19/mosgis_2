...
public class PropertyDocuments extends EJBResource <PropertyDocumentLocal> {
    ...
    private void checkOrg (JsonObject item) {
        ...
        if (itemOrg == null) throw new InternalServerErrorException ("Wrong PropertyDocument, no org: " + item);
