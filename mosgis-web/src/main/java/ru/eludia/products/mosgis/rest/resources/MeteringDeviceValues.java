...
@Path ("metering_device_values")
public class MeteringDeviceValues extends EJBResource <MeteringDeviceValueLocal> {
/*    
    ...
    private void checkOrg (JsonObject item) {
        ...
        if (itemOrg == null) throw new InternalServerErrorException ("Wrong MeteringDeviceValue, no org: " + item);
