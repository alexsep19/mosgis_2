...
@Path ("org_works")
public class OrganizationWorks extends EJBResource <OrganizationWorkLocal> {
    ...
    private void checkOrg (JsonObject item) {
        ...
        if (itemOrg == null) throw new InternalServerErrorException ("Wrong OrganizationWork, no org: " + item);
