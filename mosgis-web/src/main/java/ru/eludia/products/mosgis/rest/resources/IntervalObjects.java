...
@Path ("interval_objects")
public class IntervalObjects extends EJBResource <IntervalObjectLocal> {
/*    
    ...
    private void checkOrg (JsonObject item) {
        ...
        if (itemOrg == null) throw new InternalServerErrorException ("Wrong IntervalObject, no org: " + item);
