...
@Path ("tarif_diffs")
public class TarifDiffs extends EJBResource <TarifDiffLocal> {
/*    
    ...
    private void checkOrg (JsonObject item) {
        ...
        if (itemOrg == null) throw new InternalServerErrorException ("Wrong PremiseUsageTarifDiff, no org: " + item);
