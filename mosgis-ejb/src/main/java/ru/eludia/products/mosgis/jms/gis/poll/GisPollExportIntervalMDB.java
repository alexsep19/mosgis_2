...
import ru.eludia.products.mosgis.db.model.tables.Interval.c;
import ru.eludia.products.mosgis.ejb.wsc.WsGisVolumeQualityClient;
import ru.gosuslugi.dom.schema.integration.base.ErrorMessageType;
import ru.gosuslugi.dom.schema.integration.volume_quality.GetStateResult;
import ru.gosuslugi.dom.schema.integration.base.CommonResultType;

@MessageDriven(activationConfig = {
 @ActivationConfigProperty(propertyName = "destinationLookup", propertyValue = "mosgis.outExportIntervalsQueue")
 , @ActivationConfigProperty(propertyName = "subscriptionDurability", propertyValue = "Durable")
 , @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue")
})
public class GisPollExportIntervalMDB  extends GisPollMDB {

    @EJB
    WsGisVolumeQualityClient wsGisVolumeQualityClient;
    ...
    protected Get get (UUID uuid) {
        ...
        return (Get) ModelHolder.getModel ().get (getTable (), uuid, "AS root", "*")                
            ...
            .toOne (IntervalLog.class, "AS log", "uuid", "action").on ("log.uuid_out_soap=root.uuid")
    ...
    protected void handleOutSoapRecord (DB db, UUID uuid, Map<String, Object> r) throws SQLException {
        ...
        Interval.Action action = Interval.Action.forStatus (
        ...
        try {
            ...
            h.put (Interval.c.INTERVALGUID.lc (), cr.getGUID ());
...
logger.info ("h=" + h);
        ...
        db.update (Interval.class, h);
        
        h.put ("uuid", uuid);
        db.update (IntervalLog.class, h);
    ...
    private GetStateResult getState (UUID orgPPAGuid, Map<String, Object> r) throws GisPollRetryException, GisPollException {
        ...
        try {
            rp = wsGisVolumeQualityClient.getState (orgPPAGuid, (UUID) r.get ("uuid_ack"));
        }
        catch (Fault ex) {
