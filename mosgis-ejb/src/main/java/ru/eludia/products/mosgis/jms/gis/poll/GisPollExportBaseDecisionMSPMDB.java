...
import ru.eludia.products.mosgis.db.model.tables.BaseDecisionMSP.c;
...
@MessageDriven(activationConfig = {
 @ActivationConfigProperty(propertyName = "destinationLookup", propertyValue = "mosgis.outExportNsiBaseDecisionMSPsQueue")
 , @ActivationConfigProperty(propertyName = "subscriptionDurability", propertyValue = "Durable")
 , @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue")
})
public class GisPollExportBaseDecisionMSPMDB extends GisPollMDB {
    ...
    protected Get get (UUID uuid) {
        return (Get) ModelHolder.getModel ().get (getTable (), uuid, "AS root", "*")                
            .toOne (BaseDecisionMSPLog.class,     "AS log", "uuid", "action", "id_ctr_status").on ("log.uuid_out_soap=root.uuid")
            .toOne (BaseDecisionMSP.class,        "AS r", "uuid").on ()
    ...
    protected void handleOutSoapRecord (DB db, UUID uuid, Map<String, Object> r) throws SQLException {
        ...
        BaseDecisionMSP.Action action = BaseDecisionMSP.Action.forStatus (VocGisStatus.i.forId (r.get ("log.id_ctr_status")));
...
logger.info ("h=" + h);
        ...
        db.update (BaseDecisionMSP.class, h);
        
        h.put ("uuid", uuid);
        db.update (BaseDecisionMSPLog.class, h);
