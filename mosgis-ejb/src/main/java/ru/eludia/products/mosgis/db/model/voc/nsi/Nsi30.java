...
public class Nsi30 extends View {
    ...
    public Nsi30 () {        
        super  ("vw_nsi_30", "Типы приборов учёта");
        cols   (c.class);
        pk     (c.ID);        
    }
    ...
    public final String getSQL () {
        ...
        return "SELECT "
            + " code id, "
            + VocNsi30.c.F_BC6A38A0D9.name () + " label "
            + "FROM "
            + " vc_nsi_30 "
            + "WHERE"
            + " isactual=1"
    ...
    public enum i {
        ...
        INDIVIDUAL (1, "Отдельная квартира"),
        COLLECTIVE (2, "Квартира коммунального заселения"),
        DORMITORY  (3, "Общежитие"),
        ;
