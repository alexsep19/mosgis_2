...
@MessageDriven(activationConfig = {
 @ActivationConfigProperty(propertyName = "destinationLookup", propertyValue = "mosgis.outExportAcknowledgmentsQueue")
 , @ActivationConfigProperty(propertyName = "subscriptionDurability", propertyValue = "Durable")
 , @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue")
})
public class GisPollExportAcknowledgmentMDB  extends GisPollMDB {
    ...
    protected void handleOutSoapRecord (DB db, UUID uuid, Map<String, Object> r) throws SQLException {
        ...
        Acknowledgment.Action action = Acknowledgment.Action.forStatus (VocGisStatus.i.forId (r.get ("log.id_ctr_status")));
...
logger.info ("h=" + h);
        ...
        db.update (Acknowledgment.class, h);
        
        h.put ("uuid", uuid);
        db.update (AcknowledgmentLog.class, h);
