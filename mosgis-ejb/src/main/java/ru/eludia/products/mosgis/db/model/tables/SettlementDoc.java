...
public class SettlementDoc extends EnTable {
	...
	trigger("BEFORE INSERT OR UPDATE", ""
		...
		+ " IF :NEW.ID_SD_STATUS <> :OLD.ID_SD_STATUS THEN "
		+ "   IF :NEW.ID_SD_STATUS=" + VocGisStatus.i.PENDING_RQ_PLACING + " THEN "
		...
		+ "   END IF; "
		+ "   UPDATE tb_st_doc_ps o "
		+ "     SET o.id_sp_status = :NEW.ID_SD_STATUS "
		+ "   WHERE o.is_deleted = 0 "
		+ "     AND o.id_sp_status <>  " + VocGisStatus.i.ANNUL
		+ "     AND o.uuid_st_doc = :NEW.uuid; "
		+ " END IF; " // IF :NEW.ID_SD_STATUS <> :OLD.ID_SD_STATUS 
		+ " COMMIT; "
