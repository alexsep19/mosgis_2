...
public class GisPollExportPublicPropertyContractMDB  extends GisPollMDB {
...
logger.info ("h=" + h);
        ...
        db.update (PublicPropertyContract.class, h);
        
        h.put ("uuid", uuid);
        db.update (PublicPropertyContractLog.class, h);
