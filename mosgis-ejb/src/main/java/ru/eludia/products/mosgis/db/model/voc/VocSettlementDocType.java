...
public class VocSettlementDocType extends Table {
    
    private static final String TABLE_NAME = "vc_st_doc_types";
    
    public VocSettlementDocType () {
        super (TABLE_NAME, "Типы расчетов");
        cols  (c.class);        
        pk    (c.ID);
        data  (i.class);
    }
	...
	public ru.eludia.base.model.def.Num asDef() {
        ...
        public static i forId (Object iD) {
            ...
            throw new IllegalArgumentException ("Invalid VocSettlementDocType id: " + iD);
        }
