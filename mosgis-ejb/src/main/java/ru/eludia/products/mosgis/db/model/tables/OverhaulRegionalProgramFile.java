...
public class OverhaulRegionalProgramFile extends AttachTable {
    ...
    public OverhaulRegionalProgramFile () {
        
        super ("tb_oh_reg_pr_files", "Файлы документов региональных программ капитального ремонта");
        
        cols(OverhaulRegionalProgramFile.c.class);

        key("parent", c.UUID_OH_REG_PR_DOC);
