...
import ru.eludia.products.mosgis.db.model.tables.PremiseUsageTarif.c;
...
@MessageDriven(activationConfig = {
 @ActivationConfigProperty(propertyName = "destinationLookup", propertyValue = "mosgis.outExportPremiseUsageTarifsQueue")
 , @ActivationConfigProperty(propertyName = "subscriptionDurability", propertyValue = "Durable")
 , @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue")
})
public class GisPollExportPremiseUsageTarifMDB  extends GisPollMDB {
    ...
    protected Get get (UUID uuid) {
        ...
        return (Get) ModelHolder.getModel ().get (getTable (), uuid, "AS root", "*")                
            ...
            .toOne (PremiseUsageTarifLog.class, "AS log", "uuid", "action").on ("log.uuid_out_soap=root.uuid")
    ...
    protected void handleOutSoapRecord (DB db, UUID uuid, Map<String, Object> r) throws SQLException {
        ...
        PremiseUsageTarif.Action action = PremiseUsageTarif.Action.forStatus (
	    ...
	    List<CommonResultType> commonResult = state.getImportResult();
            ...
            h.put (PremiseUsageTarif.c.TARIFFGUID.lc (), cr.getGUID ());
...
logger.info ("h=" + h);
        ...
        db.update (PremiseUsageTarif.class, h);
        
        h.put ("uuid", uuid);
        db.update (PremiseUsageTarifLog.class, h);
    ...
    private GetStateResult getState (UUID orgPPAGuid, Map<String, Object> r) throws GisPollRetryException, GisPollException {
        ...
        try {
            rp = wsGisTariffClient.getState (orgPPAGuid, (UUID) r.get ("uuid_ack"));
        }
        catch (Fault ex) {
