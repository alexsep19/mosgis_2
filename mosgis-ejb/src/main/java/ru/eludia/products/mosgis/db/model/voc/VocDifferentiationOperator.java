...
public class VocDifferentiationOperator extends Table {

    private static final String TABLE_NAME = "vc_diff_value_ops";

    public VocDifferentiationOperator () {
        super (TABLE_NAME, "Операторы критериев дифференциации");
        cols  (c.class);
        pk    (c.ID);
        data  (i.class);
    }
    ...
    public enum i {
        ...
        EXCLUDINGRANGE  ("ExcludingRange", "Исключая диапазон значений")
        ;
