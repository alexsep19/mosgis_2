...
@MessageDriven(activationConfig = {
 @ActivationConfigProperty(propertyName = "destinationLookup", propertyValue = "mosgis.inExportMeteringDeviceFilesQueue")
 , @ActivationConfigProperty(propertyName = "subscriptionDurability", propertyValue = "Durable")
 , @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue")
})
public class ExportMeteringDeviceFilesMDB extends UUIDMDB<MeteringDeviceFile> {
    ...
    protected Get get (UUID uuid) {        
        ...
        return (Get) ModelHolder.getModel ()
            .get (getTable (), uuid, "*")
            .toOne (MeteringDevice.class, "AS r").on ()
            ...
            try (
                ...
                GisRestStream out = new GisRestStream (
                    ...
                    (uploadId, attachmentHash) -> {
                        ...
                        db.update (MeteringDeviceFile.class, r);

                        db.update (MeteringDeviceFileLog.class, HASH (
                            "uuid",           r.get ("id_log"),
                ...
                db.getStream (ModelHolder.getModel ().get (MeteringDeviceFile.class, uuid, "body"), out);
            }
