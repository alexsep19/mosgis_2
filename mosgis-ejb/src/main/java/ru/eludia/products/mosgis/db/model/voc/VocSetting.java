...
public class VocSetting extends Table {
    ...
    public enum i {
        ...
        WS_GIS_FILES_URL      ("ws.gis.files.url", "Endpoint URL файлового REST-сервиса ГИС ЖКХ", "https://217.107.108.156:10081/ext-bus-file-store-service/rest/"),
        ...
        WS_GIS_BILLS_URL      ("ws.gis.bills.url", "Endpoint URL сервиса обмена сведениями о начислениях, взаиморасчетах ГИС ЖКХ (BillsServiceAsync)", "https://217.107.108.156:10081/ext-bus-bills-service/services/BillsAsync/"),
        ...
        WS_GIS_NSI_URL      ("ws.gis.nsi.url", "Endpoint URL сервиса частной НСИ ГИС ЖКХ (NsiAsyncService)", "https://217.107.108.156:10081/ext-bus-nsi-service/services/NsiAsync"),
        ...
        WS_GIS_NSI_COMMON_URL      ("ws.gis.nsi.common.url", "Endpoint URL сервиса НСИ ГИС ЖКХ (NsiCommonAsyncService)", "https://217.107.108.156:10081/ext-bus-nsi-service/services/NsiAsync"),
        ...
        WS_GIS_ORG_COMMON_URL      ("ws.gis.org.common.url", "Endpoint URL сервиса реестра юрлиц ГИС ЖКХ (NsiCommonAsyncService)", "https://217.107.108.156:10081/ext-bus-org-registry-common-service/services/OrgRegistryCommonAsync"),
        ...
        WS_GIS_HOUSE_MANAGEMENT_URL      ("ws.gis.house.management.url", "Endpoint URL сервиса обмена сведениями о жилищном фонде ГИС ЖКХ (HouseManagementServiceAsync)", "https://217.107.108.156:10081/ext-bus-home-management-service/services/HomeManagementAsync"),
