...
public class VocLegalActLevel extends Table {

    private static final String TABLE_NAME = "vc_legal_act_levels";

    public VocLegalActLevel () {
        super (TABLE_NAME, "Уровень (сфера действия) НПА");
        cols  (c.class);
        pk    (c.ID);
        data  (i.class);
    }
