...
import ru.eludia.products.mosgis.db.model.tables.AccountIndividualService.c;
...
@MessageDriven(activationConfig = {
 @ActivationConfigProperty(propertyName = "destinationLookup", propertyValue = "mosgis.outExportAccountIndividualServicesQueue")
 , @ActivationConfigProperty(propertyName = "subscriptionDurability", propertyValue = "Durable")
 , @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue")
})
public class GisPollExportIndividualServiceMDB  extends GisPollMDB {
    ...
    protected void handleOutSoapRecord (DB db, UUID uuid, Map<String, Object> r) throws SQLException {
        ...
        AccountIndividualService.Action action = AccountIndividualService.Action.forStatus (
        ...
        try {
            ...
            h.put (AccountIndividualService.c.ACCOUNTINDIVIDUALSERVICEGUID.lc (), cr.getGUID ());
...
logger.info ("h=" + h);
        ...
        db.update (AccountIndividualService.class, h);
        
        h.put ("uuid", uuid);
        db.update (AccountIndividualServiceLog.class, h);
