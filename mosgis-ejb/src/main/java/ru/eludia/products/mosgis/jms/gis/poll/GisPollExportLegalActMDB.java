...
import ru.eludia.products.mosgis.db.model.tables.LegalAct.c;
...
@MessageDriven(activationConfig = {
 @ActivationConfigProperty(propertyName = "destinationLookup", propertyValue = "mosgis.outExportLegalActsQueue")
 , @ActivationConfigProperty(propertyName = "subscriptionDurability", propertyValue = "Durable")
 , @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue")
})
public class GisPollExportLegalActMDB  extends GisPollMDB {
    ...
    protected Get get (UUID uuid) {
        ...
        return (Get) ModelHolder.getModel ().get (getTable (), uuid, "AS root", "*")                
            ...
            .toOne (LegalActLog.class, "AS log", "uuid", "action").on ("log.uuid_out_soap=root.uuid")
    ...
    protected void handleOutSoapRecord (DB db, UUID uuid, Map<String, Object> r) throws SQLException {
        ...
        LegalAct.Action action = LegalAct.Action.forStatus (
        ...
        try {
            ...
            List<CommonResultType> commonResult = state.getImportDocumentResult ();
            ...
            h.put (LegalAct.c.DOCUMENTGUID.lc (), cr.getGUID ());
...
logger.info ("h=" + h);
        ...
        db.update (LegalAct.class, h);
        
        h.put ("uuid", uuid);
        db.update (LegalActLog.class, h);
