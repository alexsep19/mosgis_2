...
public class VocGisStatus extends Table {
    ...
    public enum i {
        ...
        PENDING_RQ_PLACE_PROGRAM_WORKS  (-22, "_pending_rq_place_program_works", "ожидание размещения видов работ"),
        PENDING_RP_PLACE_PROGRAM_WORKS  (-23, "_pending_rp_place_program_works", "ожидание подтверждения размещения видов работ"),
        
        PROGRAM_WORKS_PLACE_FINISHED    (-31, "_program_works_place_finished", "завершено размещение видов работ"),
