...
public class InImportSubsidiaries extends Table {

    public InImportSubsidiaries () {
        
        super  ("in_js_import_subsidiaries",     "Входящие пакетные запросы на регистрацию/изменение юрлиц (переведённые в JSON)");
