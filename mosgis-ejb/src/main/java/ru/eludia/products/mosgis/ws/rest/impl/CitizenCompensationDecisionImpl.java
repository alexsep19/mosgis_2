...
public class CitizenCompensationDecisionImpl extends BaseCRUD<CitizenCompensationDecision> implements CitizenCompensationDecisionLocal {
    ...
    private void checkFilter (JsonObject data, CitizenCompensationDecision.c field, Select select) {
        String key = field.lc ();
	...
	Select select = m.select (getTable (), "AS root", "*")
	    .orderBy (CitizenCompensationDecision.c.DECISIONDATE.lc() + " DESC")
            .limit (p.getInt ("offset"), p.getInt ("limit"));

        JsonObject data = p.getJsonObject ("data");

        checkFilter (data, CitizenCompensationDecision.c.UUID_CIT_COMP, select);
