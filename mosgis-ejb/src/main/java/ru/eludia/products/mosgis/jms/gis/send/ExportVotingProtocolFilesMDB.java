...
@MessageDriven(activationConfig = {
 @ActivationConfigProperty(propertyName = "destinationLookup", propertyValue = "mosgis.inHouseVotingProtocolFilesQueue")
 , @ActivationConfigProperty(propertyName = "subscriptionDurability", propertyValue = "Durable")
 , @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue")
})
public class ExportVotingProtocolFilesMDB extends UUIDMDB<VotingProtocolFile> {
    ...
    protected Get get (UUID uuid) {        
        ...
        return (Get) ModelHolder.getModel ()
            .get (getTable (), uuid, "*")
            .toOne (VotingProtocol.class, "AS vp").on ()
            ...
            try (
                ...
                GisRestStream out = new GisRestStream (
                    ...
                    (uploadId, attachmentHash) -> {
                        ...
                        db.update (VotingProtocolFile.class, r);
                ...
                db.getStream (ModelHolder.getModel ().get (VotingProtocolFile.class, uuid, "body"), out);
            }
