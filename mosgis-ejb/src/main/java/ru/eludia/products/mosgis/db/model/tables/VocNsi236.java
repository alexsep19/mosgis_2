...
public class VocNsi236 extends Table {
    ...
    public enum c implements EnColEnum {
        ...
        GUID_VC_NSI_3         (STRING, new Virt("''||F_D966DD6CBC"), "Вид коммунальной услуги (синоним)"),
        GUID_VC_NSI_239       (STRING, new Virt("''||F_ADEBB17EBE"), "Вид коммунального ресурса (синоним)"),
