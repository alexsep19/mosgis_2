...
public class VocSupplyResourceContractFileType extends Table {

    private static final String TABLE_NAME = "vc_sr_ctr_file_types";

    public VocSupplyResourceContractFileType () {
        super (TABLE_NAME, "Типы документов, приложенных к ДРС");
        cols  (c.class);
        pk    (c.ID);
        data  (i.class);
    }
    ...
    public enum i {
        ...
        CONTRACT     (1, "Договор"),
        ADDENDUM     (2, "Приложение к договору"),
        OTHER        (3, "Прочие")
        ;
