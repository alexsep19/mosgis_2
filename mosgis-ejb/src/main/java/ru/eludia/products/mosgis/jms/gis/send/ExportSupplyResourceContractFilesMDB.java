...
@MessageDriven(activationConfig = {
 @ActivationConfigProperty(propertyName = "destinationLookup", propertyValue = "mosgis.inHouseSupplyResourceContractFilesQueue")
 , @ActivationConfigProperty(propertyName = "subscriptionDurability", propertyValue = "Durable")
 , @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue")
})
public class ExportSupplyResourceContractFilesMDB extends UUIDMDB<SupplyResourceContractFile> {
    ...
    protected Get get (UUID uuid) {        
        ...
        return (Get) ModelHolder.getModel ()
            .get (getTable (), uuid, "*")
            .toOne (SupplyResourceContract.class, "AS vp").on ()
            ...
            try (
                ...
                GisRestStream out = new GisRestStream (
                    ...
                    (uploadId, attachmentHash) -> {
                        ...
                        db.update (SupplyResourceContractFile.class, r);

                        db.update (SupplyResourceContractFileLog.class, HASH (
                            "uuid",           r.get ("id_log"),
                ...
                db.getStream (ModelHolder.getModel ().get (SupplyResourceContractFile.class, uuid, "body"), out);
            }
