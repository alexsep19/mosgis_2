...
import ru.eludia.products.mosgis.rest.api.PublicPropertyContractDocsLocal;
import ru.eludia.products.mosgis.rest.impl.base.BaseCRUD;
import ru.eludia.products.mosgis.web.base.ComplexSearch;

@Stateless
@TransactionAttribute(TransactionAttributeType.NOT_SUPPORTED)
public class PublicPropertyContractDocsImpl extends BaseCRUD<PublicPropertyContractFile> implements PublicPropertyContractDocsLocal  {

    private static final Logger logger = Logger.getLogger (PublicPropertyContractDocsImpl.class.getName ());    

    private static final String PARENT_REF = PublicPropertyContractFile.c.UUID_CTR.lc ();
    ...
    public JsonObject doUpdate (String id, JsonObject p, User user) {return doAction (db -> {
        ...
        final PublicPropertyContractFile table = (PublicPropertyContractFile) getTable ();
    ...
    public JsonObject doDelete (String id, User user) {return doAction (db -> {
        ...
        JsonObject houseFile = db.getJsonObject (ModelHolder.getModel ().get (PublicPropertyContractFile.class, id, "*"));
    ...
    public JsonObject select (JsonObject p, User u) {return fetchData ((db, job) -> {
        ...
        Select select = ModelHolder.getModel ()
            ...
            .toMaybeOne (PublicPropertyContract.class, "AS obj").on ()
