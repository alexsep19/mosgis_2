...
import ru.eludia.products.mosgis.db.model.tables.SocialNormTarif.c;
...
@MessageDriven(activationConfig = {
 @ActivationConfigProperty(propertyName = "destinationLookup", propertyValue = "mosgis.outExportSocialNormTarifsQueue")
 , @ActivationConfigProperty(propertyName = "subscriptionDurability", propertyValue = "Durable")
 , @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue")
})
public class GisPollExportSocialNormTarifMDB  extends GisPollMDB {
    ...
    protected Get get (UUID uuid) {
        ...
        return (Get) ModelHolder.getModel ().get (getTable (), uuid, "AS root", "*")                
            ...
            .toOne (SocialNormTarifLog.class, "AS log", "uuid", "action").on ("log.uuid_out_soap=root.uuid")
    ...
    protected void handleOutSoapRecord (DB db, UUID uuid, Map<String, Object> r) throws SQLException {
        ...
        SocialNormTarif.Action action = SocialNormTarif.Action.forStatus (
	    ...
	    List<CommonResultType> commonResult = state.getImportResult();
            ...
            h.put (SocialNormTarif.c.TARIFFGUID.lc (), cr.getGUID ());
...
logger.info ("h=" + h);
        ...
        db.update (SocialNormTarif.class, h);
        
        h.put ("uuid", uuid);
        db.update (SocialNormTarifLog.class, h);
