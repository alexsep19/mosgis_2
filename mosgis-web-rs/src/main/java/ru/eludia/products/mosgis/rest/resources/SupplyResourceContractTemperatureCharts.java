...
@Path ("supply_resource_contract_temperature_charts")
public class SupplyResourceContractTemperatureCharts extends EJBResource <SupplyResourceContractTemperatureChartLocal> {
