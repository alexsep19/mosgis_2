...
@Path ("general_needs_municipal_resources")
public class GeneralNeedsMunicipalResources extends EJBResource <GeneralNeedsMunicipalResourceLocal> {
/*    
    ...
    private void checkOrg (JsonObject item) {
        ...
        if (itemOrg == null) throw new InternalServerErrorException ("Wrong GeneralNeedsMunicipalResource, no org: " + item);
