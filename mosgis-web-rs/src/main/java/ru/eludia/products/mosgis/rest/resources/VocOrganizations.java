...
public class VocOrganizations extends EJBResource <VocOrganizationsLocal> {
    ...
    @POST
    @Path("{id}/import_sr_contracts")
    @Produces (APPLICATION_JSON)
    @RolesAllowed ("admin")
    public JsonObject doImportSrContracts (@PathParam ("id") String id) {
        return back.doImportSrContracts (id, getUser ());
    }
    ...
    @POST    
    @Path("{id}/import_accounts") 
    @Produces (APPLICATION_JSON)
    @RolesAllowed ("admin")
    public JsonObject doImportAccounts (@PathParam ("id") String id) { 
        return back.doImportAccounts (id, getUser ());
    }
